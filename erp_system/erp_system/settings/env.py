...
SECRET_KEY = "django-insecure-#_(*%nzov(t_4p*564v)#m^67re4-)y=%i^$z_39-!i^6r!_pr"
...
JWT_AUTH = {
    ...
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'erp_system.utils.jwt_handler.jwt_response_payload_handler',
}
